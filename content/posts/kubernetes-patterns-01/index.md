...
{{< figure src="/posts/kubernetes-patterns-01/images/2.png" caption="Kubernetes Distributed Primitives — Container를 중심으로 Pod, Volume, 각종 컨트롤러가 연결된 전체 구조" >}}
...
{{< figure src="/posts/kubernetes-patterns-01/images/image.png" caption="같은 Pod 안의 컨테이너들은 localhost와 Disk를 공유한다" >}}
