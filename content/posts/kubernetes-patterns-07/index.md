...
<div style="font-size:16px;line-height:2.1;font-family:inherit;">
  ...
  <div style="padding-left:20px;font-size:15px;">
    <div><a href="#example-7-1-job-명세" style="color:var(--secondary,inherit);text-decoration:none;">3.1 Example 7-1. Job 명세</a></div>
    <div><a href="#완료-판정-기준-exit-code" style="color:var(--secondary,inherit);text-decoration:none;">3.2 완료 판정 기준: Exit Code</a></div>
  </div>
  ...
  <div style="padding-left:20px;font-size:15px;">
    <div><a href="#indexed-job" style="color:var(--secondary,inherit);text-decoration:none;">5.1 Indexed Job</a></div>
    <div><a href="#work-queue-job" style="color:var(--secondary,inherit);text-decoration:none;">5.2 Work Queue Job</a></div>
  </div>
  ...
  <div style="padding-left:20px;font-size:15px;">
    <div><a href="#73-두-전략-비교" style="color:var(--secondary,inherit);text-decoration:none;">7.1 두 전략 비교</a></div>
  </div>
