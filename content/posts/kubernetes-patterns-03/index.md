...
<div style="display:flex;gap:8px;margin-bottom:12px;align-items:center;flex-wrap:wrap;">
  <button class="k3btn k3btn-s" id="ov-bb" onclick="ovB()">◀ 이전</button>
  <button class="k3btn k3btn-p" id="ov-bn" onclick="ovN()">다음 ▶</button>
  <button class="k3btn k3btn-s" onclick="ovR()">↺ 초기화</button>
  <span id="ov-lbl" style="font-size:13px;color:#999;margin-left:4px;"></span>
</div>
<div style="width:65%;margin:0 auto;min-width:260px;">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 460 490" style="width:100%;font-family:inherit;">
  <defs>
    <marker id="ov-ar" markerWidth="8" markerHeight="7" refX="7" refY="3.5" orient="auto"><polygon points="0,0 8,3.5 0,7" fill="#bbb"/></marker>
  </defs>
  <!-- Developer -->
  <g id="ov-dev" style="opacity:.15">
    <rect x="150" y="10" width="160" height="44" rx="10" fill="#fff" stroke="#e0e0e0" stroke-width="1" style="filter:drop-shadow(0 2px 6px rgba(0,0,0,0.08))"/>
    <text x="230" y="37" fill="#1e1e1e" font-size="14" font-weight="600" text-anchor="middle" font-family="inherit">개발자 (YAML)</text>
  </g>
  <!-- Arrow 1 -->
  <g id="ov-a1" style="opacity:.15">
    <line x1="230" y1="54" x2="230" y2="86" stroke="#bbb" stroke-width="1.5" marker-end="url(#ov-ar)"/>
    <text x="238" y="74" fill="#aaa" font-size="11" font-family="inherit">kubectl apply</text>
  </g>
  <!-- Deployment -->
  <g id="ov-dep" style="opacity:.15">
    <rect x="130" y="88" width="200" height="48" rx="10" fill="#fff" stroke="#e0e0e0" stroke-width="1" style="filter:drop-shadow(0 2px 6px rgba(0,0,0,0.08))"/>
    <text x="230" y="106" fill="#1e1e1e" font-size="13" font-weight="700" text-anchor="middle" font-family="inherit">Deployment</text>
    <text x="230" y="124" fill="#aaa" font-size="11" text-anchor="middle" font-family="inherit">선언: replicas=3, RollingUpdate</text>
  </g>
  <!-- Arrow 2 -->
  <g id="ov-a2" style="opacity:.15">
    <line x1="230" y1="136" x2="230" y2="168" stroke="#bbb" stroke-width="1.5" marker-end="url(#ov-ar)"/>
    <text x="238" y="155" fill="#aaa" font-size="11" font-family="inherit">생성</text>
  </g>
  <!-- RS v1 -->
  <g id="ov-rs1" style="opacity:.15">
    <rect x="60" y="170" width="160" height="44" rx="8" fill="#fff" stroke="#6ea8d4" stroke-width="1.5" stroke-dasharray="6,3"/>
    <text x="140" y="197" fill="#4472a8" font-size="13" font-weight="600" text-anchor="middle" font-family="inherit">ReplicaSet v1</text>
  </g>
  <!-- RS v2 (hidden initially, appears on update) -->
  <g id="ov-rs2" style="opacity:.15;display:none">
    <rect x="240" y="170" width="160" height="44" rx="8" fill="#fff" stroke="#5aaa7a" stroke-width="1.5" stroke-dasharray="6,3"/>
    <text x="320" y="197" fill="#2d7a4a" font-size="13" font-weight="600" text-anchor="middle" font-family="inherit">ReplicaSet v2</text>
  </g>
  <!-- Arrow 3 v1 -->
  <g id="ov-a3" style="opacity:.15">
    <line x1="140" y1="214" x2="140" y2="246" stroke="#bbb" stroke-width="1.5" marker-end="url(#ov-ar)"/>
  </g>
  <!-- Arrow 3 v2 -->
  <g id="ov-a3b" style="opacity:.15;display:none">
    <line x1="320" y1="214" x2="320" y2="246" stroke="#bbb" stroke-width="1.5" marker-end="url(#ov-ar)"/>
  </g>
  <!-- Pods v1 -->
  <g id="ov-pods1" style="opacity:.15">
    <rect x="34" y="248" width="82" height="54" rx="8" fill="#d4e4f7" stroke="#6ea8d4" stroke-width="1.5"/>
    <text x="75" y="270" fill="#1a56db" font-size="11" font-weight="600" text-anchor="middle" font-family="inherit">Pod</text>
    <text x="75" y="289" fill="#34a853" font-size="16" font-weight="700" text-anchor="middle" font-family="inherit">✓</text>
    <rect x="124" y="248" width="82" height="54" rx="8" fill="#d4e4f7" stroke="#6ea8d4" stroke-width="1.5"/>
    <text x="165" y="270" fill="#1a56db" font-size="11" font-weight="600" text-anchor="middle" font-family="inherit">Pod</text>
    <text x="165" y="289" fill="#34a853" font-size="16" font-weight="700" text-anchor="middle" font-family="inherit">✓</text>
    <rect x="214" y="248" width="82" height="54" rx="8" fill="#d4e4f7" stroke="#6ea8d4" stroke-width="1.5"/>
    <text x="255" y="270" fill="#1a56db" font-size="11" font-weight="600" text-anchor="middle" font-family="inherit">Pod</text>
    <text x="255" y="289" fill="#34a853" font-size="16" font-weight="700" text-anchor="middle" font-family="inherit">✓</text>
  </g>
  <!-- Pods v2 (hidden) -->
  <g id="ov-pods2" style="opacity:.15;display:none">
    <rect x="214" y="248" width="82" height="54" rx="8" fill="#c8e6d4" stroke="#5aaa7a" stroke-width="1.5"/>
    <text x="255" y="270" fill="#137333" font-size="11" font-weight="600" text-anchor="middle" font-family="inherit">Pod</text>
    <text x="255" y="289" fill="#34a853" font-size="16" font-weight="700" text-anchor="middle" font-family="inherit">✓</text>
    <rect x="304" y="248" width="82" height="54" rx="8" fill="#c8e6d4" stroke="#5aaa7a" stroke-width="1.5"/>
    <text x="345" y="270" fill="#137333" font-size="11" font-weight="600" text-anchor="middle" font-family="inherit">Pod</text>
    <text x="345" y="289" fill="#34a853" font-size="16" font-weight="700" text-anchor="middle" font-family="inherit">✓</text>
    <rect x="394" y="248" width="82" height="54" rx="8" fill="#c8e6d4" stroke="#5aaa7a" stroke-width="1.5"/>
    <text x="435" y="270" fill="#137333" font-size="11" font-weight="600" text-anchor="middle" font-family="inherit">Pod</text>
    <text x="435" y="289" fill="#34a853" font-size="16" font-weight="700" text-anchor="middle" font-family="inherit">✓</text>
  </g>
  <!-- Arrow 4 -->
  <g id="ov-a4" style="opacity:.15">
    <line x1="230" y1="302" x2="230" y2="354" stroke="#bbb" stroke-width="1.5" marker-end="url(#ov-ar)"/>
    <text x="238" y="330" fill="#aaa" font-size="11" font-family="inherit">트래픽</text>
  </g>
  <!-- Service -->
  <g id="ov-svc" style="opacity:.15">
    <rect x="130" y="356" width="200" height="50" rx="10" fill="#fff" stroke="#e0e0e0" stroke-width="1" style="filter:drop-shadow(0 2px 6px rgba(0,0,0,0.08))"/>
    <text x="230" y="376" fill="#1e1e1e" font-size="13" font-weight="700" text-anchor="middle" font-family="inherit">Service</text>
    <text x="230" y="394" fill="#aaa" font-size="11" text-anchor="middle" font-family="inherit">ClusterIP / 로드밸런싱</text>
  </g>
  <!-- Arrow 5 -->
  <g id="ov-a5" style="opacity:.15">
    <line x1="230" y1="406" x2="230" y2="436" stroke="#bbb" stroke-width="1.5" marker-end="url(#ov-ar)"/>
  </g>
  <!-- User -->
  <g id="ov-usr" style="opacity:.15">
    <rect x="160" y="438" width="140" height="40" rx="8" fill="#f8f8f8" stroke="#e0e0e0" stroke-width="1"/>
    <text x="230" y="463" fill="#666" font-size="13" text-anchor="middle" font-family="inherit">사용자</text>
  </g>
</svg>
</div>
<div id="ov-info" class="k3info"></div>
</div>
<script>
(function(){
  const ELS=['ov-dev','ov-a1','ov-dep','ov-a2','ov-rs1','ov-rs2','ov-a3','ov-a3b','ov-pods1','ov-pods2','ov-a4','ov-svc','ov-a5','ov-usr'];
  const ST=[
    {show:[],hide:['ov-rs2','ov-a3b','ov-pods2'],
     info:'YAML 선언 전. Kubernetes는 아무것도 모른다.'},
    {show:['ov-dev'],hide:['ov-rs2','ov-a3b','ov-pods2'],
     info:'개발자가 YAML을 작성한다. replicas=3, 이미지 버전, RollingUpdate 전략을 선언하는 과정이다.'},
    {show:['ov-dev','ov-a1','ov-dep'],hide:['ov-rs2','ov-a3b','ov-pods2'],
     info:'<code style="background:#f0f0f0;padding:1px 5px;border-radius:3px;color:#1e1e1e;font-size:12px;">kubectl apply</code>로 Deployment 오브젝트가 생성된다. Kubernetes가 선언된 상태를 유지하기 시작한다.'},
    {show:['ov-dev','ov-a1','ov-dep','ov-a2','ov-rs1'],hide:['ov-rs2','ov-a3b','ov-pods2'],
     info:'Deployment가 ReplicaSet을 생성한다. Deployment는 직접 Pod를 만들지 않는다 — ReplicaSet이 Pod 개수를 관리한다.'},
    {show:['ov-dev','ov-a1','ov-dep','ov-a2','ov-rs1','ov-a3','ov-pods1'],hide:['ov-rs2','ov-a3b','ov-pods2'],
     info:'ReplicaSet이 Pod 3개를 생성하고 유지한다. 하나가 죽으면 즉시 새 Pod를 띄워 replicas=3을 보장한다.'},
    {show:['ov-dev','ov-a1','ov-dep','ov-a2','ov-rs1','ov-a3','ov-pods1','ov-a4','ov-svc','ov-a5','ov-usr'],hide:['ov-rs2','ov-a3b','ov-pods2'],
     info:'Service가 Pod에 트래픽을 라우팅한다. 사용자는 Service를 통해 애플리케이션에 접근한다.'},
    {show:['ov-dev','ov-a1','ov-dep','ov-a2','ov-rs1','ov-rs2','ov-a3','ov-a3b','ov-pods1','ov-pods2','ov-a4','ov-svc','ov-a5','ov-usr'],hide:[],
     info:'업데이트 시작. 새 이미지 버전으로 kubectl apply. Deployment가 ReplicaSet v2를 생성하고 Pod를 하나씩 교체한다. 업데이트 내내 Service는 준비된 Pod에만 트래픽을 보낸다.'},
  ];
  let cur=0;
  const $=id=>document.getElementById(id);
  function render(){
    const s=ST[cur];
    ELS.forEach(id=>{const e=$(id);if(!e)return; e.style.opacity='0.15'; e.style.display='block';});
    s.show.forEach(id=>{const e=$(id);if(e)e.style.opacity='1';});
    s.hide.forEach(id=>{const e=$(id);if(e)e.style.display='none';});
    $('ov-info').innerHTML=s.info;
    $('ov-lbl').textContent=`${cur} / ${ST.length-1}`;
    $('ov-bb').disabled=cur===0; $('ov-bn').disabled=cur===ST.length-1;
  }
  window.ovN=()=>{if(cur<ST.length-1){cur++;render();}};
  window.ovB=()=>{if(cur>0){cur--;render();}};
  window.ovR=()=>{cur=0;render();};
  render();
})();
</script>
{{< /rawhtml >}}
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 580 270" style="width:100%;font-family:inherit;">
  <defs>
  ...
  <!-- Service -->
  <rect x="220" y="12" width="140" height="52" rx="8" fill="#fff" stroke="#e0e0e0" stroke-width="1.5" style="filter:drop-shadow(0 2px 6px rgba(0,0,0,0.08))"/>
  <text x="290" y="36" fill="#1e1e1e" font-size="13" font-weight="700" text-anchor="middle" font-family="inherit">Service</text>
  <text id="bg-sel" x="290" y="52" fill="#aaa" font-size="10" text-anchor="middle" font-family="inherit">selector: version=v1.0</text>
  <!-- Arrow Service → Blue -->
  <line id="bg-abl" x1="248" y1="64" x2="158" y2="106" stroke="#1e1e1e" stroke-width="2" marker-end="url(#bg-ar-act)"/>
  <g id="bg-ablx" style="display:none"><line x1="192" y1="80" x2="204" y2="92" stroke="#ea4335" stroke-width="2.5" stroke-linecap="round"/><line x1="204" y1="80" x2="192" y2="92" stroke="#ea4335" stroke-width="2.5" stroke-linecap="round"/></g>
  <!-- Arrow Service → Green -->
  <line id="bg-agl" x1="332" y1="64" x2="422" y2="106" stroke="#ccc" stroke-width="1.5" stroke-dasharray="5,3" marker-end="url(#bg-ar)"/>
  <g id="bg-aglx" style="display:none"><line x1="370" y1="80" x2="382" y2="92" stroke="#ea4335" stroke-width="2.5" stroke-linecap="round"/><line x1="382" y1="80" x2="370" y2="92" stroke="#ea4335" stroke-width="2.5" stroke-linecap="round"/></g>
  <!-- Blue env -->
  <g id="bg-blue">
    <rect x="14" y="108" width="276" height="140" rx="10" fill="#e8f0fe" stroke="#4285f4" stroke-width="1.5"/>
    <text x="152" y="126" fill="#1a56db" font-size="12" font-weight="700" text-anchor="middle" font-family="inherit">Blue (v1.0)</text>
    <rect x="30" y="134" width="74" height="96" rx="6" fill="#c5d8f8" stroke="#4285f4" stroke-width="1"/>
    <text x="67" y="172" fill="#1a56db" font-size="11" font-weight="600" text-anchor="middle" font-family="inherit">v 1.0</text>
    <text id="bg-b1" x="67" y="196" fill="#34a853" font-size="20" font-weight="700" text-anchor="middle" font-family="inherit">✓</text>
    <rect x="118" y="134" width="74" height="96" rx="6" fill="#c5d8f8" stroke="#4285f4" stroke-width="1"/>
    <text x="155" y="172" fill="#1a56db" font-size="11" font-weight="600" text-anchor="middle" font-family="inherit">v 1.0</text>
    <text id="bg-b2" x="155" y="196" fill="#34a853" font-size="20" font-weight="700" text-anchor="middle" font-family="inherit">✓</text>
    <rect x="206" y="134" width="74" height="96" rx="6" fill="#c5d8f8" stroke="#4285f4" stroke-width="1"/>
    <text x="243" y="172" fill="#1a56db" font-size="11" font-weight="600" text-anchor="middle" font-family="inherit">v 1.0</text>
    <text id="bg-b3" x="243" y="196" fill="#34a853" font-size="20" font-weight="700" text-anchor="middle" font-family="inherit">✓</text>
  </g>
  <!-- Green env -->
  <g id="bg-green">
    <rect x="290" y="108" width="276" height="140" rx="10" fill="#e6f4ea" stroke="#34a853" stroke-width="1.5"/>
    <text x="428" y="126" fill="#137333" font-size="12" font-weight="700" text-anchor="middle" font-family="inherit">Green (v1.1)</text>
    <rect x="306" y="134" width="74" height="96" rx="6" fill="#b8dfca" stroke="#34a853" stroke-width="1"/>
    <text x="343" y="172" fill="#137333" font-size="11" font-weight="600" text-anchor="middle" font-family="inherit">v 1.1</text>
    <text id="bg-g1" x="343" y="196" fill="#4285f4" font-size="20" text-anchor="middle" font-family="inherit">↻</text>
    <rect x="394" y="134" width="74" height="96" rx="6" fill="#b8dfca" stroke="#34a853" stroke-width="1"/>
    <text x="431" y="172" fill="#137333" font-size="11" font-weight="600" text-anchor="middle" font-family="inherit">v 1.1</text>
    <text id="bg-g2" x="431" y="196" fill="#4285f4" font-size="20" text-anchor="middle" font-family="inherit">↻</text>
    <rect x="482" y="134" width="74" height="96" rx="6" fill="#b8dfca" stroke="#34a853" stroke-width="1"/>
    <text x="519" y="172" fill="#137333" font-size="11" font-weight="600" text-anchor="middle" font-family="inherit">v 1.1</text>
    <text id="bg-g3" x="519" y="196" fill="#4285f4" font-size="20" text-anchor="middle" font-family="inherit">↻</text>
  </g>
</svg>
...
(function(){
  const ST=[
    {sel:'selector: version=v1.0',abl:1,ablx:0,agl:0,aglx:0,
     g1:'↻',g2:'↻',g3:'↻',gc:'#4285f4',b1:'✓',b2:'✓',b3:'✓',bc:'#34a853',
     blue:1,green:1,
     info:'Blue(v1.0)가 트래픽을 받는 중. Green(v1.1)은 별도 Deployment로 배포되어 준비 중 (↻).'},
    {sel:'selector: version=v1.0',abl:1,ablx:0,agl:0,aglx:0,
     g1:'✓',g2:'✓',g3:'✓',gc:'#34a853',b1:'✓',b2:'✓',b3:'✓',bc:'#34a853',
     blue:1,green:1,
     info:'Green Pod 3개 전부 준비 완료 (✓). 아직 트래픽은 Blue로만. selector 변경 전이라 Service는 Blue를 바라본다.'},
    {sel:'selector: version=v1.1',abl:0,ablx:1,agl:1,aglx:0,
     g1:'✓',g2:'✓',g3:'✓',gc:'#34a853',b1:'✓',b2:'✓',b3:'✓',bc:'#34a853',
     blue:1,green:1,
     info:'Service selector를 <code style="background:#f0f0f0;padding:1px 5px;border-radius:3px;color:#1e1e1e;font-size:12px;">version=v1.1</code>로 변경. 트래픽이 즉시 Green으로 전환. 문제 발생 시 selector를 되돌리면 즉시 롤백.'},
    {sel:'selector: version=v1.1',abl:0,ablx:0,agl:1,aglx:0,
     g1:'✓',g2:'✓',g3:'✓',gc:'#34a853',b1:'✓',b2:'✓',b3:'✓',bc:'#34a853',
     blue:0,green:1,
     info:'Blue Deployment 삭제 완료. 리소스 반환. 다음 배포 시 Green → Blue 방향으로 동일 절차 반복.'},
  ];
  let cur=0;
  const $=id=>document.getElementById(id);
  function show(id,v){const e=$(id);if(e)e.style.display=v?'block':'none';}
  function render(){
    ...
    show('bg-abl',s.abl); show('bg-ablx',s.ablx);
    const agl=$('bg-agl');
    if(agl){agl.style.display=s.agl?'block':'none'; agl.setAttribute('stroke',s.agl?'#1e1e1e':'#ccc'); agl.setAttribute('stroke-dasharray',s.agl?'none':'5,3'); agl.setAttribute('marker-end',s.agl?'url(#bg-ar-act)':'url(#bg-ar)');}
    show('bg-aglx',s.aglx);
    show('bg-blue',s.blue);
    ['g1','g2','g3'].forEach(k=>{const e=$(`bg-${k}`);if(e){e.textContent=s[k];e.setAttribute('fill',s.gc);}});
    ['b1','b2','b3'].forEach(k=>{const e=$(`bg-${k}`);if(e){e.textContent=s[k];e.setAttribute('fill',s.bc);}});
    $('bg-info').innerHTML=s.info;
    $('bg-lbl').textContent=`${cur} / ${ST.length-1}`;
...
<div style="font-family:system-ui,sans-serif;padding:8px 0;margin:1.5rem 0;">
<div style="display:flex;gap:8px;margin-bottom:12px;align-items:center;flex-wrap:wrap;">
  <button class="k3btn k3btn-s" id="ca-bb" onclick="caB()">◀ 이전</button>
  <button class="k3btn k3btn-p" id="ca-bn" onclick="caN()">다음 ▶</button>
  <button class="k3btn k3btn-s" onclick="caR()">↺ 초기화</button>
  <span id="ca-lbl" style="font-size:13px;color:#999;margin-left:4px;"></span>
</div>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 580 240" style="width:100%;font-family:inherit;">
  <defs>
    <marker id="ca-ar" markerWidth="8" markerHeight="7" refX="7" refY="3.5" orient="auto"><polygon points="0,0 8,3.5 0,7" fill="#888"/></marker>
  </defs>
  <!-- Service -->
  <rect x="220" y="10" width="140" height="48" rx="8" fill="#fff" stroke="#e0e0e0" stroke-width="1.5" style="filter:drop-shadow(0 2px 6px rgba(0,0,0,0.08))"/>
  <text x="290" y="30" fill="#1e1e1e" font-size="13" font-weight="700" text-anchor="middle" font-family="inherit">Service</text>
  <text id="ca-ratio" x="290" y="48" fill="#aaa" font-size="10" text-anchor="middle" font-family="inherit">v1 100%</text>
  <!-- arrows -->
  <line x1="258" y1="58" x2="158" y2="100" stroke="#888" stroke-width="1.5" marker-end="url(#ca-ar)"/>
  <line x1="322" y1="58" x2="422" y2="100" stroke="#888" stroke-width="1.5" marker-end="url(#ca-ar)"/>
  <!-- v1 pods row -->
  <text x="152" y="98" fill="#4472a8" font-size="11" font-weight="700" text-anchor="middle" font-family="inherit">v1 Deployment</text>
  <g id="ca-v1p1"><rect x="18" y="104" width="74" height="70" rx="6" fill="#d4e4f7" stroke="#6ea8d4" stroke-width="1.5"/><text x="55" y="136" fill="#1a56db" font-size="11" font-weight="600" text-anchor="middle" font-family="inherit">v 1.0</text><text x="55" y="158" fill="#34a853" font-size="18" font-weight="700" text-anchor="middle" font-family="inherit">✓</text></g>
  <g id="ca-v1p2"><rect x="100" y="104" width="74" height="70" rx="6" fill="#d4e4f7" stroke="#6ea8d4" stroke-width="1.5"/><text x="137" y="136" fill="#1a56db" font-size="11" font-weight="600" text-anchor="middle" font-family="inherit">v 1.0</text><text x="137" y="158" fill="#34a853" font-size="18" font-weight="700" text-anchor="middle" font-family="inherit">✓</text></g>
  <g id="ca-v1p3"><rect x="182" y="104" width="74" height="70" rx="6" fill="#d4e4f7" stroke="#6ea8d4" stroke-width="1.5"/><text x="219" y="136" fill="#1a56db" font-size="11" font-weight="600" text-anchor="middle" font-family="inherit">v 1.0</text><text x="219" y="158" fill="#34a853" font-size="18" font-weight="700" text-anchor="middle" font-family="inherit">✓</text></g>
  <g id="ca-v1p4"><rect x="264" y="104" width="74" height="70" rx="6" fill="#d4e4f7" stroke="#6ea8d4" stroke-width="1.5"/><text x="301" y="136" fill="#1a56db" font-size="11" font-weight="600" text-anchor="middle" font-family="inherit">v 1.0</text><text x="301" y="158" fill="#34a853" font-size="18" font-weight="700" text-anchor="middle" font-family="inherit">✓</text></g>
  <!-- v2 canary pods -->
  <text id="ca-v2lbl" x="490" y="98" fill="#2d7a4a" font-size="11" font-weight="700" text-anchor="middle" font-family="inherit" style="display:none">v2 Canary</text>
  <g id="ca-v2p1" style="display:none"><rect x="406" y="104" width="74" height="70" rx="6" fill="#c8e6d4" stroke="#5aaa7a" stroke-width="1.5"/><text x="443" y="136" fill="#137333" font-size="11" font-weight="600" text-anchor="middle" font-family="inherit">v 1.1</text><text x="443" y="158" fill="#34a853" font-size="18" font-weight="700" text-anchor="middle" font-family="inherit">✓</text></g>
  <g id="ca-v2p2" style="display:none"><rect x="488" y="104" width="74" height="70" rx="6" fill="#c8e6d4" stroke="#5aaa7a" stroke-width="1.5"/><text x="525" y="136" fill="#137333" font-size="11" font-weight="600" text-anchor="middle" font-family="inherit">v 1.1</text><text x="525" y="158" fill="#34a853" font-size="18" font-weight="700" text-anchor="middle" font-family="inherit">✓</text></g>
  <!-- traffic bar -->
  <rect x="18" y="196" width="544" height="24" rx="4" fill="#e8e8e8"/>
  <rect id="ca-bar1" x="18" y="196" width="544" height="24" rx="4" fill="#4285f4"/>
  <rect id="ca-bar2" x="18" y="196" width="0" height="24" rx="4" fill="#34a853"/>
  <text id="ca-bar1t" x="290" y="213" fill="#fff" font-size="11" font-weight="700" text-anchor="middle" font-family="inherit">v1 100%</text>
  <text id="ca-bar2t" x="562" y="213" fill="#fff" font-size="11" font-weight="700" text-anchor="end" font-family="inherit" style="display:none"></text>
</svg>
<div id="ca-info" class="k3info"></div>
</div>
<script>
(function(){
  const ST=[
    {v1:[1,1,1,1],v2:[0,0],r:'v1 100%',b1:544,b2:0,bt1:'v1 100%',bt2:'',
     info:'초기 상태. v1.0 Pod 4개 (모의 5개 중 4개), 트래픽 100% v1.0. 새 버전 배포 전.'},
    {v1:[1,1,1,1],v2:[1,0],r:'v1 80% / v2 20%',b1:435,b2:109,bt1:'v1 80%',bt2:'v2 20%',
     info:'v2 Canary Deployment 생성 (replicas=1). 전체 5 Pod 중 1개가 v2. 소수 사용자(약 20%)만 새 버전을 경험.'},
    {v1:[1,1,1,1],v2:[1,0],r:'v1 80% / v2 20% — 모니터링 중',b1:435,b2:109,bt1:'v1 80%',bt2:'v2 20%',
     info:'v2 Pod 상태 모니터링 중. 에러율, 응답 속도 정상 → 점진적 전환 계속 진행.'},
    {v1:[1,1,0,0],v2:[1,1],r:'v1 50% / v2 50%',b1:272,b2:272,bt1:'v1 50%',bt2:'v2 50%',
     info:'v2 replicas 증가, v1 replicas 감소. 트래픽 비율이 점진적으로 이동. 각 단계마다 모니터링 후 진행.'},
    {v1:[0,0,0,0],v2:[1,1],r:'v2 100%',b1:0,b2:544,bt1:'',bt2:'v2 100%',
     info:'전환 완료. v1 Deployment 삭제. 전체 트래픽이 v2로. 문제 발생 시 <code style="background:#f0f0f0;padding:1px 5px;border-radius:3px;color:#1e1e1e;font-size:12px;">kubectl delete deployment app-v2</code>로 즉시 v1 복귀.'},
  ];
  let cur=0;
  const $=id=>document.getElementById(id);
  function show(id,v){const e=$(id);if(e)e.style.display=v?'block':'none';}
  function render(){
    const s=ST[cur];
    [1,2,3,4].forEach(i=>{show(`ca-v1p${i}`,s.v1[i-1]);});
    [1,2].forEach(i=>{show(`ca-v2p${i}`,s.v2[i-1]);});
    show('ca-v2lbl',s.v2[0]);
    $('ca-ratio').textContent=s.r;
    $('ca-bar1').setAttribute('width',s.b1);
    $('ca-bar2').setAttribute('width',s.b2); $('ca-bar2').setAttribute('x',18+s.b1);
    $('ca-bar1t').textContent=s.bt1; $('ca-bar1t').setAttribute('x',18+s.b1/2);
    $('ca-bar2t').textContent=s.bt2; show('ca-bar2t',!!s.bt2);
    if(s.bt2)$('ca-bar2t').setAttribute('x',18+s.b1+s.b2/2);
    $('ca-info').innerHTML=s.info;
    $('ca-lbl').textContent=`${cur} / ${ST.length-1}`;
    $('ca-bb').disabled=cur===0; $('ca-bn').disabled=cur===ST.length-1;
  }
  window.caN=()=>{if(cur<ST.length-1){cur++;render();}};
  window.caB=()=>{if(cur>0){cur--;render();}};
  window.caR=()=>{cur=0;render();};
  render();
})();
</script>
{{< /rawhtml >}}
